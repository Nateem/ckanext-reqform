...
class DBTest(unittest.TestCase):
    ...
    def test_initdb_not_initialized(self):
        ...
        table_reqform_follower = MagicMock()

        db.sa.Table = MagicMock(side_effect=[table_data_request, table_comment, table_reqform_follower])
        ...
        model.meta.mapper.assert_any_call(db.DataRequestFollower, table_reqform_follower)
    ...
    def test_reqform_exist(self, first_result, expected_result):
        ...
        result = db.DataRequest.reqform_exists(title)
    ...
    def test_reqform_get_ordered_by_date(self, params):
    ...
    def test_get_open_reqforms_number(self):
        ...
        filter_by = MagicMock()
        filter_by.scalar.return_value = n_reqforms
        ...
        result = db.DataRequest.get_open_reqforms_number()

        # Assertions
        self.assertEquals(n_reqforms, result)
    ...
    @parameterized.expand([
        ...
        ({'reqform_id': 'example_uuid_v4', 'desc': False},),
        ({'reqform_id': 'example_uuid_v4', 'desc': True},),
    ])
    def test_comment_get_ordered_by_date(self, params):
        self._test_get_ordered_by_date('Comment', 'time', params)

    def test_get_reqforms_comments(self):
        ...
        db.Comment.id = 'id'
        result = db.Comment.get_comment_reqforms_number(**params)
    ...
    def test_reqform_follower_get(self):
        self._test_get('DataRequestFollower')

    def test_get_reqform_followers_number(self):
        ...
        result = db.DataRequestFollower.get_reqform_followers_number(**params)
